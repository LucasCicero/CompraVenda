...
<html lang="pt-br" xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <title>Compra & Venda - Atualizar Compra</title>
		...
		<main class="container">
			...
			<form method="post">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" value="${compras.quantidade_compra}" name="quantidade_compra" required />
				</div>
				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							...
							<input type="date" class="form-control" value="${compras.data_compra}" name="data_compra" required />
						</div>
					</div>
