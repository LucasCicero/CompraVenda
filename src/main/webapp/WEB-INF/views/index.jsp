	...
	<body>
		...
		<main class="container">
			...
			<table class="table table-hover table-responsive w-auto table-striped">
				...
				<tbody>
					<c:forEach var="produtosIndex" items="${produtosIndex}" varStatus="i">
						<tr>
							<td>
								<span>${produtosIndex.nome_produto}</span>								
							</td>	
							<td>${produtosIndex.descricao}</td>
							<td>${produtosIndex.preco_compra}</td>
							<td>${produtosIndex.preco_venda}</td>
							<td>${produtosIndex.quantidade_disponivel}</td>
							<td>${produtosIndex.liberado_venda}</td>
